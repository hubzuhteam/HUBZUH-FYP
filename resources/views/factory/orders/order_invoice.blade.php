    ...
    <div class="row">
        <div class="col-xs-12">
    		<div class="invoice-title">
    			<h2>Invoice HUBZUH</h2><h3 class="pull-right">Order # {{ $orderDetails->id }}</h3>
    		</div>
    		<hr>
    		<div class="row">
    			<div class="col-xs-6">
            ...
            <div class="row">
                    <div class="col-xs-6">
                            ...
                            <strong>Supplier Details</strong><br>
                                Store ID: {{ $factoryDetails->id }} <br>
                                Store Name:{{ $factoryDetails->store_name }} <br>
                                Name: {{ $factoryDetails->name }} <br>
                                Store Email: {{ $factoryDetails->store_email }} <br>
                            </address>
                        </div>
                </div>
    	</div>
    					...
    					<table class="table table-condensed">
    						...
    						<tbody>
    							...
    							<tr>
    								...
    								<td class="text-right">PKR {{ $pro->product_price * $pro->product_qty }}</td>
    							</tr>
    							...
    							<tr>
    								...
    								<td class="thick-line text-right">PKR {{ $Subtotal }}</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
    								...
    								<td class="no-line text-right">PKR 0</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
    								...
    								<td class="no-line text-right">PKR {{ $orderDetails->coupon_amount }}</td>
    							</tr>
    							<tr>
    								<td class="no-line"></td>
    								<td class="no-line"></td>
    								...
    								<td class="no-line text-right">PKR {{ $orderDetails->grand_total }}</td>
    							</tr>
    						</tbody>
    					</table>
    				</div>
