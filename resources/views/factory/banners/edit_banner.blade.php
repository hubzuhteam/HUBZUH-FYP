                ...
                <div id="step-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 offset-md-2" style="margin-top: 30px">
                                <legend  class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">Edit Banner</legend>
                                ...
                                <div class="form-group row m-b-10">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="title" id="title" value="{{ $bannerDetails->title }}" placeholder="Title" class="form-control" required/>
                                    </div>
                                </div>
                                <!-- end form-group row -->
                                <div class="form-group row m-b-10">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" name="link" id="link" value="{{ $bannerDetails->link }}" placeholder="same as title and without space" class="form-control" required/>
                                        </div>
                                    </div>
                                <!-- begin form-group row -->
                                <div class="form-group row m-b-10">
                                    ...
                                    <div class="col-md-6">
                                            <input type="hidden" name="status" class="form-control m-b-10" id="status" value="1" @if($bannerDetails->status=="1") checked @endif>
                                    </div>
                                </div>
                                <!-- end form-group row -->
