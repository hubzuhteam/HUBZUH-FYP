...
<div id="content" class="content">
    ...
    @endif
    <form action="{{ url('/factory/add-product') }}" enctype="multipart/form-data" method="POST" name="add_product" class="form-control-with-bg">{{ csrf_field() }}
        <!-- begin wizard -->
        <div id="wizard">
                ...
                <div id="step-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 offset-md-2">
                                <legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">Add New Product</legend>
