...
<div id="content" class="content">
    ...
    @endif
    <form action="{{ url('factory/edit-product/'.$productDetails->id) }}" enctype="multipart/form-data" method="POST" name="edit_product" class="form-control-with-bg">{{ csrf_field() }}
        <!-- begin wizard -->
        <div id="wizard">
                                    ...
                                    <div class="col-md-6" id="uniform-undefined" >
                                        <div id="uniform-undefined">
                                            ...
                                            @if(!empty($productDetails->video))
                                              ...
                                              <a href="{{ url('/factory/delete-product-video/'.$productDetails->id) }}">Delete</a>
                                            @endif
                                          </div>
                                        </div>
                                </div>
