...
<div id="content" class="content">
    ...
    @endif
    <form action="{{ url('/factory/add-attributes/'.$productDetails->id) }}" enctype="multipart/form-data" method="POST" name="add_attribute" id="add_attribute" class="form-control-with-bg">{{ csrf_field() }}
        <!-- begin wizard -->
