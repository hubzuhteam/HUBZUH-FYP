...
<body class="app">
    ...
    <div class="peers ai-s fxw-nw h-100vh">
            <div class="d-n@sm- peer peer-greed h-100 pos-r bgr-n bgpX-c bgpY-c bgsz-cv" style="background-image:url(assets/static/images/banner_back.jpeg)">
        ...
        <div class="col-12 col-md-4 peer pX-40 pY-80 h-100 bgc-white scrollable pos-r" style="min-width:320px">
            ...
            <h4 class="fw-300 c-grey-900 mB-40">Factory Register</h4>
            @if(Session::has('flash_message_error'))
                    ...
                    @endif
            <form action="{{ url('/factory/factory-register')}}" method="POST" class="margin-bottom-0">{{ csrf_field() }}            
                <div class="form-group">
                        <label class="text-normal text-dark">Name</label>
                        <input type="text" name="name" class="form-control" placeholder="Name" required>
                </div>
                <div class="form-group">
                        <label class="text-normal text-dark">Factory Name</label>
                ...
                <div class="m-t-20 m-b-40 p-b-40 text-inverse">
                        Already a member? Click <a href="{{ url('/factory/login')}}">here</a> to login.
                </div>
            </form>
        </div>
    </div>
