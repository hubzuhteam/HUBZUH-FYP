          ...
          <div class="inbox_msg">
                    ...
                    <div class="chat_list active_chat">
                      <div class="chat_people">
                        ...
                        <div class="chat_ib">
                            ...
                            @endif
                            @endforeach
                          <p style="color: black;"><strong><a href="{{url('factory/view_messages/'.$user_id)}}">View Messages</a></strong></p>
                        </div>
                      </div>
                    </div>
                    @endforeach
            ...
            <div class="mesgs" style="background-color: lightsteelblue;">
                ...
                @endforeach
                      ...
                      <form action="{{ url('/factory/send-message/'.$receiver) }}" method="post">{{csrf_field()}}
                    <div class="type_msg">
