{{--  Theme Store/factory 1st Template  --}}
@section('content')
	...
	<div class="container"  >
            <div class="alert alert-success alert-block">
                    <button type="button" class="close" data-dismiss="alert">×</button>
                        <strong style="font-size: 24px">You can Add your store Image, Edit Main Color, Edit Seconday Color, Set Background Image, Add multiple Images in Banner etc.</strong>
            </div>
		<div class="fb-profile" style="margin-bottom: 40px;margin-top: 0px;" >
			<div style="margin: 0px" id="slider-carousel" class="carousel slide" data-ride="carousel" >
				<div class="carousel-inner" >
						<div >
							<a  title="Banner 1"><img onerror="imgErrorBanner(this);"  src="{{ asset('images/frontend_images/banners/83777.jpg' )}}"></a>
						</div>
				</div>
				...
				<img align="left" style="border-radius: 0%;" onerror="imgError(this);"  class="fb-image-profile thumbnail" src="{{ asset('images/supplierend_images/store_images/small/store.gif')}} " alt="Profile image example"/>
