            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu media-list dropdown-menu-right">
                    ...
                    <li class="media">
                        <a href="javascript:;">
                            <div class="media-left">
                                <img src="{{ asset('images/supplierend_images/user/user-1.jpg')}}" class="media-object" alt="" />
                    ...
                    <li class="media">
                        <a href="javascript:;">
                            <div class="media-left">
                                <img src="{{ asset('images/supplierend_images/user/user-2.jpg')}}" class="media-object" alt="" />
                                <i class="fab fa-facebook-messenger text-primary media-object-icon"></i>
                            </div>
                            <div class="media-body">
