...
<div id="content">
  ...
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{url('/admin/view-products')}}">Products</a> <a href="{{url('/admin/view-products')}}" class="current">View Products</a> </div>
    <h1>Products</h1>
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td class="center">
                    ...
                    class="btn btn-info btn-mini" title="View product">View</a> <a
