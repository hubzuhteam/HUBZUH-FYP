...
@section('content')
    ...
    <div id="content" class="content">
        ...
        <div  class="col-md-8 offset-md-2" style="margin-top: 5%;"  >
            ...
            <form action="{{ url('/supplier/branches/' )}}" style="margin-top: 5% align-cont" method="post" name="edit_profile" class="form-control-with-bg">{{ csrf_field() }}

                    <div  class="jumbotron m-b-0 text-center col-sm-2" style="background-color: transparent">
                            <input type="submit" value="Add/Edit Branches" class="btn btn-purple btn-lg">
                    </div>
