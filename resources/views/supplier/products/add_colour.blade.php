...
<div id="content" class="content">
    ...
    @endif
    <form action="{{ url('/supplier/add-colour/'.$productDetails->id) }}" enctype="multipart/form-data" method="POST" name="add_colour" id="add_colour" class="form-control-with-bg">{{ csrf_field() }}
        <!-- begin wizard -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 offset-md-2">
                                ...
                                <div class="jumbotron m-b-0 text-center" style="background-color: transparent">
                                        <input type="submit" value="Add Colour" class="btn btn-primary btn-lg">
                            </div>
                            </div>
                            {{-- end personal info --}}
                            <!-- end col-8 -->
    ...
    <div class="panel panel-inverse">
        ...
        <div class="panel-body">
                <form action="{{ url('supplier/edit-colour/'.$productDetails->id) }}" method="post">{{csrf_field()}}
            <table id="data-table-default" class="table table-striped table-bordered">
                ...
                <tbody>
                        ...
                        <tr class="gradeX">
                          <td><input type="hidden" name="idAttr[]" value="{{ $colour->id }}"></td>
                          <td>{{ $colour->sku }}</td>
                          <td>{{ $colour->colour }}</td>
                          ...
                          <td class="center">
                            ...
                            <a id="delProduct"
                             href="{{ url('/supplier/delete-colour/'.$colour->id) }}"
