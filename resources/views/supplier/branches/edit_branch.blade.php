...
<div id="content" class="content">
    ...
    @endif
    <form enctype="multipart/form-data" action="{{ url('/supplier/edit-branch/'.$branch->id) }}" method="POST" class="form-control-with-bg">{{ csrf_field() }}
        <!-- begin wizard -->
        <div id="wizard">
                ...
                <div id="step-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 offset-md-2">
                                <legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">Edit Information about this Branch</legend>
                                ...
                                <div class="form-group row m-b-10">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="branch_name" value="{{ $branch->branch_name }}"  placeholder="Branch Name" class="form-control" />
                                    </div>
                                </div>
                                <!-- end form-group row -->
                                <!-- begin form-group row -->
                                <div class="form-group row m-b-10">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="branch_location" value="{{ $branch->branch_location }}" placeholder="Branch Location"  class="form-control" />
                                    </div>
                                </div>
                                <!-- end form-group row -->
                                <!-- begin form-group row -->
                                <div class="form-group row m-b-10">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="branch_phn_no" name="branch_phn_no" value="{{ $branch->branch_phn_no }}" placeholder="Phone Number of Branch"  class="form-control" />
                                    </div>
                                </div>
                                <!-- end form-group row -->
                                <div class="jumbotron m-b-0 text-center" style="background-color: transparent">
                                    <input type="submit" value="Update Branch" class="btn btn-primary btn-lg">
                                </div>
                            </div>
                            {{-- end personal info --}}
                ...
                <table id="data-table-default" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr class="gradeX">
                          ...
                          <td class="center">
                            <a target="_blank" href="{{ url('supplier/edit-branch/'.$branch->id)}}"
                                class="btn btn-success btn-mini">Edit Branch</a>
                                <br>
                                <br>
                                <a target="_blank" href="{{ url('supplier/delete-branch/'.$branch->id)}}"
